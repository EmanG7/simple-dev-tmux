...
SHOW_DATETIME=$(tmux show-option -gv @simple-dev-tmux_show_datetime 2>/dev/null)
...
date_format=$(tmux show-option -gv @simple-dev-tmux_date_format 2>/dev/null)
time_format=$(tmux show-option -gv @simple-dev-tmux_time_format 2>/dev/null)
